...
public class GamePanel extends JPanel {
     ...
     * Sets up the main visual game, links backend methods & logic to GUI, and
     * handles & performs user action
     * 
     ...
     */
    public GamePanel(Board board, Player player1, Player player2, boolean isComputerPlayerActive,
            JLabel playerTurnLabel, JLabel playerOneCaptures, JLabel playerTwoCaptures) {
        this.board = board;
        ...
        for (int rows = 0; rows < 9; rows++) {
            for (int cols = 0; cols < 9; cols++) {
                // reverse loop in coordinate declaration to fill in piece positions from
                // columns per row
    ...
    /**
     * Reloads all grid buttons to update them
     */
            ...
            if (String.valueOf(chosenCoordinate).equals(String.valueOf(desiredCoordinate))) {
                ...
                if (board.canMove(chosenCoordinate, desiredCoordinate)) {
                    ...
                    JOptionPane.showMessageDialog(this,
                            "Invalid piece movement. Remember, you can only move orthogonally!");
                    updatePanel();
                }
            }
        }
    ...
    /**
     * Runs a move, updating the board, checking for captures, and lastly reloading
     * the button grid
     * 
     * @param currentCoordinate Start coordinate for the piece to move from
     * @param desiredCoordinate End coordinate for the piece to move to
     */
    ...
    /**
     * Switches the turns and sets up GUI for the next player, calling the computer
    ...
    /**
     * Generates a random move for the computer and uses it
     */
    ...
    /**
     * Method to check if any player has won (5 captures)
     * 
     * @return true if a player has won, or false if the game is still continuing
     */
...
// --> Add Action Listener & Handle Functions